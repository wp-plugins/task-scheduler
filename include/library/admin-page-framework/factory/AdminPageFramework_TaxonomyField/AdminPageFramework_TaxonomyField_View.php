 ...
 */
abstract class TaskScheduler_AdminPageFramework_TaxonomyField_View extends TaskScheduler_AdminPageFramework_TaxonomyField_Model {
    ...
    private function _getFieldsOutput($iTermID, $bRenderTableRow) {
        ...
        $this->oForm->format();
        $_oFieldsTable = new TaskScheduler_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->_getFieldErrors(), $this->oMsg);
