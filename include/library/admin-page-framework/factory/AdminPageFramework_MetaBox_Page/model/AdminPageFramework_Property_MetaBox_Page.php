 ...
 */
class TaskScheduler_AdminPageFramework_Property_MetaBox_Page extends TaskScheduler_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['aTaskScheduler_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['aTaskScheduler_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['aTaskScheduler_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['aTaskScheduler_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['aTaskScheduler_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['aTaskScheduler_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['aTaskScheduler_AdminPageFramework']['aPageClasses'] as $__oClass) {
