...
abstract class TaskScheduler_AdminPageFramework_Factory_Router {
    ...
    protected $_aFormElementClassNameMap = array('page' => 'TaskScheduler_AdminPageFramework_FormElement_Page', 'network_admin_page' => 'TaskScheduler_AdminPageFramework_FormElement_Page', 'post_meta_box' => 'TaskScheduler_AdminPageFramework_FormElement_Meta', 'page_meta_box' => 'TaskScheduler_AdminPageFramework_FormElement', 'post_type' => 'TaskScheduler_AdminPageFramework_FormElement', 'taxonomy' => 'TaskScheduler_AdminPageFramework_FormElement', 'widget' => 'TaskScheduler_AdminPageFramework_FormElement', 'user_meta' => 'TaskScheduler_AdminPageFramework_FormElement_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'TaskScheduler_AdminPageFramework_Resource_Page', 'network_admin_page' => 'TaskScheduler_AdminPageFramework_Resource_Page', 'post_meta_box' => 'TaskScheduler_AdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'TaskScheduler_AdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'TaskScheduler_AdminPageFramework_Resource_PostType', 'taxonomy' => 'TaskScheduler_AdminPageFramework_Resource_TaxonomyField', 'widget' => 'TaskScheduler_AdminPageFramework_Resource_Widget', 'user_meta' => 'TaskScheduler_AdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'TaskScheduler_AdminPageFramework_HelpPane_Page', 'network_admin_page' => 'TaskScheduler_AdminPageFramework_HelpPane_Page', 'post_meta_box' => 'TaskScheduler_AdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'TaskScheduler_AdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'TaskScheduler_AdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'TaskScheduler_AdminPageFramework_HelpPane_Widget', 'user_meta' => 'TaskScheduler_AdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'TaskScheduler_AdminPageFramework_Link_Page', 'network_admin_page' => 'TaskScheduler_AdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'TaskScheduler_AdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'TaskScheduler_AdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'TaskScheduler_AdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'TaskScheduler_AdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    public function _replyTpSetAndGetInstance_oMsg() {
        $this->oMsg = TaskScheduler_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
        return $this->oMsg;
    }
