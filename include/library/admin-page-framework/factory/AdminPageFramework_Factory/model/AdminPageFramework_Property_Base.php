 ...
 */
abstract class TaskScheduler_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aTaskScheduler_AdminPageFramework'] = isset($GLOBALS['aTaskScheduler_AdminPageFramework']) && is_array($GLOBALS['aTaskScheduler_AdminPageFramework']) ? $GLOBALS['aTaskScheduler_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : TaskScheduler_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
