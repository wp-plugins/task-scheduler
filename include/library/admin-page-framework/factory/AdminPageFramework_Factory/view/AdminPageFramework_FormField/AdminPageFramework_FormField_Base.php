 ...
 */
abstract class TaskScheduler_AdminPageFramework_FormField_Base extends TaskScheduler_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new TaskScheduler_AdminPageFramework_Script_Widget;
        ...
        new TaskScheduler_AdminPageFramework_Script_Utility;
        new TaskScheduler_AdminPageFramework_Script_OptionStorage;
        new TaskScheduler_AdminPageFramework_Script_AttributeUpdator;
        new TaskScheduler_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new TaskScheduler_AdminPageFramework_Script_Sortable;
        new TaskScheduler_AdminPageFramework_Script_RegisterCallback;
    }
