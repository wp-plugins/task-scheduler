 ...
 */
class TaskScheduler_AdminPageFramework_FormField extends TaskScheduler_AdminPageFramework_FormField_FieldDefinition {
    ...
    private function _getInputName(array $aField, $sKey = '', $hfFilterCallback = null) {
        ...
        return !is_callable($hfFilterCallback) ? '' : call_user_func_array($hfFilterCallback, array($_sNameAttribute, $aField, $sKey));
    }
    protected function _getFlatInputName(array $aField, $sKey = '', $hfFilterCallback = null) {
        ...
        return !is_callable($hfFilterCallback) ? '' : call_user_func_array($hfFilterCallback, array($_sFlatName, $aField, $sKey));
    }
