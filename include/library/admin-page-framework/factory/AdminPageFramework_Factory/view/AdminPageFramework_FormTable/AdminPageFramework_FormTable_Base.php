 ...
 */
class TaskScheduler_AdminPageFramework_FormTable_Base extends TaskScheduler_AdminPageFramework_FormOutput {
    ...
    private function _loadScripts() {
        ...
        new TaskScheduler_AdminPageFramework_Script_Tab;
    }
...
JAVASCRIPTS;
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new TaskScheduler_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new TaskScheduler_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . TaskScheduler_AdminPageFramework_Registry::NAME . ' ' . TaskScheduler_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}