 ...
 */
class TaskScheduler_AdminPageFramework_Property_Page extends TaskScheduler_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aTaskScheduler_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aTaskScheduler_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aTaskScheduler_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aTaskScheduler_AdminPageFramework']['aPageClasses'] : array();
