 ...
 */
abstract class TaskScheduler_AdminPageFramework_Form_Model_Export extends TaskScheduler_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new TaskScheduler_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
