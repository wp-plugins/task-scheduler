 ...
 */
abstract class TaskScheduler_AdminPageFramework_Page_View extends TaskScheduler_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _getFormOutput($sPageSlug) {
        ...
        $_oFieldsTable = new TaskScheduler_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
