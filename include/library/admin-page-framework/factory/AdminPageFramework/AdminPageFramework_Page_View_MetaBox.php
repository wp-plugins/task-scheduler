 ...
 */
abstract class TaskScheduler_AdminPageFramework_Page_View_MetaBox extends TaskScheduler_AdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aTaskScheduler_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aTaskScheduler_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aTaskScheduler_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aTaskScheduler_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aTaskScheduler_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
