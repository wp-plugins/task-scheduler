...
/**
 * Creaates a task object.
 * 
 * @remark	Do not use the constructor. Use the getInstance() method to instantiate an task objectt.
 */
final class TaskScheduler_Routine extends TaskScheduler_Routine_Thread {
	...
	public function resetStatus() {
		...
		$this->setMeta( '_routine_status', 'inactive' );
