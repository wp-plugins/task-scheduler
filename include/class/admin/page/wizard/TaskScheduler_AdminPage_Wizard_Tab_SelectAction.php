...
abstract class TaskScheduler_AdminPage_Wizard_Tab_SelectAction extends TaskScheduler_AdminPage_Wizard_Tab_Wizard {
	 ...
	 */
	protected function _setWizard_SelectAction( $sTransientKey ) {
	 ...
	 * @since	1.0.0
	 */
	public function validation_TaskScheduler_AdminPage_Wizard_wizard_select_action( $aInput, $aOldInput ) {	// validation_{instantiated class name}_{section ID}
